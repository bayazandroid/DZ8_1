...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Medic doc = new Medic(220, 0, "Айболит", SuperPower.BOOST);
        Magic magic = new Magic(240, 15, "Стрэндж");
        Berserk berserk = new Berserk(250, 10, "", SuperPower.BLOCK);
        Medic assistant = new Medic(245, 5, "Джун", SuperPower.BOOST);
    ...
    private static void printStatistics(Boss boss, game.players.Hero[] heroes) {
